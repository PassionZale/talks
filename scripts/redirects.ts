...
[[redirects]]
  from = "${base}pdf"
  to = "https://github.com/passionzale/talks/blob/main/${dir}/${pdfFile}?raw=true"
  status = 302
...
[[redirects]]
  from = "${base}src"
  to = "https://github.com/passionzale/talks/tree/main/${dir}"
  status = 302`)

    parts.push(`
[[redirects]]
  from = "${dir}"
  to = "https://talks.lovchun.com${base}"
  status = 301
...
[[redirects]]
  from = "/"
  to = "https://github.com/passionzale/talks"
  status = 302
`
